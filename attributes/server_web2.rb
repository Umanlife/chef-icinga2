...
default['icinga2']['web2']['ssl']['certificate'] = '/etc/ssl/certs/wildcard.pem'
default['icinga2']['web2']['ssl']['certificate_chain'] = '/etc/ssl/certs/wildcard-bundle.crt'
default['icinga2']['web2']['ssl']['private_key'] = '/etc/ssl/private/wildcard.key'
